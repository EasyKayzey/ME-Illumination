...
double T = 4000, DELTA_T, N_T_double = 4000;
int N_T;
...
int N_FP = 30, N_FGEN = 3, N_FTOURN = 3, GR_F = N_FP - 2, N_PRE_SEEDING = 1;
double S_FA = 0.05, S_FT = 0.1, A_MAX = 0.3, A_MIN = A_MAX * 0.5, P_FC = 0.6, B_FC = 0.3, P_FM = 0.1, BETA_FCOST = 0;
...
//    cout << "H_0 diagonal:" << endl << H0.toDenseMatrix() << endl;
        ...
        EMatrix mu_upper;
        mu_upper <<  0, 0.06116130402, -0.01272999623, 0.003275382148,  0,               0,
